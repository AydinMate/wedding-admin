...
import { Product, Image, Category, Colour, Size } from "@prisma/client";
...
const formSchema = z.object({
  ...
  categoryId: z.string().min(1).max(64, "Maximum length is 64 characters"),
  colourId: z.string().min(1).max(64, "Maximum length is 64 characters"),
  sizeId: z.string().min(1).max(64, "Maximum length is 64 characters"),
